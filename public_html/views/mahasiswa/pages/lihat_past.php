...
$sql = "SELECT * FROM event WHERE CONCAT(event_date, ' ', event_time) < NOW() ORDER BY event_date DESC";
...
<head>
  ...
  <title>Past Seminar & Workshop | SI Connect</title>
  ...
  <div class="contaier-fluid">
    ...
    <div class="p-0 container-fluid d-flex flex-column justify-content-center" style="background-color: var(--cream);">
      <div class="text-center my-5">
        <h1 class="fw-bold" data-aos="fade-down">Past Seminar & Workshop</h1>
      </div>
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4 mb-5" style="margin-inline: 12rem;">
        ...
        <?php
          ...
          echo "<p class='text-center'>Tidak ada seminar yang telah selesai.</p>";
        }
        ?>
      </div>
    </div>
